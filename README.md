...
### 4) 전통시장 활성화 -> 마케팅 방안
- **과제**: 1. 타켓 고객 (2030·외국인) 신규 유입 및 앱 설치 유도 
                     2. 유저 참여형 리뷰 생성 장려 
- 해결방안
    - **중기청, 소상공인 진흥공단 등 정부기관 및 지차체 연계 홍보**
        -  협업 리소스 활용 채널 홍보 및 전통시장 활성화 캠페인 전개 
    - **소셜미디어 마케팅** 
        - 체험형 콘텐츠 제작, UGC 유저 참여형 챌린지 등    
    - **현장 이벤트**
        - QR 코드 설치, 리뷰 활성화 등 (시장 상인회 협조 하) 

  
## 5. 핵심 타겟 및 주요 기능
<img width="7260" height="3476" alt="1차 프로젝트 (4)" src="<img width="14520" height="6952" alt="image" src="https://github.com/user-attachments/assets/5a849e43-f705-48d7-a59a-58553c613186" />
" />
...
## UX 서비스 흐름도
<img width="8491" height="4740" alt="1차 프로젝트 (9)" src="https://github.com/user-attachments/assets/84046691-cdee-4508-9ef5-fb2d3eea7b57" />
